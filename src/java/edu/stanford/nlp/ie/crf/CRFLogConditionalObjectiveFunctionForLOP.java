...
public class CRFLogConditionalObjectiveFunctionForLOP extends AbstractCachingDiffFunction {
  ...
  public void calculate(double[] x) {
    ...
    for (int m = 0; m < data.length; m++) {
      ...
      CRFCliqueTree cliqueTree = CRFCliqueTree.getCalibratedCliqueTree(combinedWeights2D, docData, labelIndices, numClasses, classIndex, backgroundSymbol);
